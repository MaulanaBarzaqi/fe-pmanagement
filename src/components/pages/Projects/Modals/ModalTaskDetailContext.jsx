...
const ModalTaskDetailProveder = ({children}) => {
    ...
    const fetchProjectMemebers = async (boardId) => {
    ...
    const initTaskDetail = async () => {
        ...
        await fetchProjectMemebers(boardId);
    };
    ...
    return (
        <ModalTaskDetailContext.Provider value={{ 
            taskId,
            listId,
            taskDetailData,
            fetchTaskDetail,
            fetchProjectMemebers,
            membersData,
         }}>
            {children}
...
export default ModalTaskDetailProveder;